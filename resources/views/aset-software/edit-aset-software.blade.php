...
@section('container')
    <div class="pagetitle">
        <h1 class="mb-4">Edit Data Aset Software</h1>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Multi Columns Form -->
                            <form action="/aset-software/{{ $data->id }}" method="post" class="row g-3 mt-4">
                                @method('put')
                                @csrf
                                <input type="hidden" class="form-control @error('slug_aset') is-invalid @enderror"
                                    id="slug_aset" name="slug_aset" value="{{ old('slug', $data->slug_aset) }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="number" class="form-control @error('nomor_urut') is-invalid @enderror"
                                        id="nomor_urut" name="nomor_urut" value="{{ old('nomor_urut', $data->nomor_urut) }}"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select id="jenis_aplikasi" name="jenis_aplikasi"
                                        ...
                                        <option value="Website"
                                            {{ (old('jenis_aplikasi') ?: $data->jenis_aplikasi == 'Website') ? 'selected' : '' }}>
                                            Website</option>
                                        <option value="Desktop"
                                            {{ (old('jenis_aplikasi') ?: $data->jenis_aplikasi == 'Desktop') ? 'selected' : '' }}>
                                            Desktop</option>
                                    </select>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control @error('unit_pengguna') is-invalid @enderror"
                                        id="unit_pengguna" name="unit_pengguna"
                                        value="{{ old('unit_pengguna', $data->unit_pengguna) }}"
