"use strict";var Ue=Object.create;var J=Object.defineProperty;var Ve=Object.getOwnPropertyDescriptor;var Ke=Object.getOwnPropertyNames;var Qe=Object.getPrototypeOf,Ge=Object.prototype.hasOwnProperty;var Ze=(h,e)=>{for(var t in e)J(h,t,{get:e[t],enumerable:!0})},ce=(h,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Ke(e))!Ge.call(h,i)&&i!==t&&J(h,i,{get:()=>e[i],enumerable:!(n=Ve(e,i))||n.enumerable});return h};var g=(h,e,t)=>(t=h!=null?Ue(Qe(h)):{},ce(e||!h||!h.__esModule?J(t,"default",{value:h,enumerable:!0}):t,h)),qe=h=>ce(J({},"__esModule",{value:!0}),h);var ht={};Ze(ht,{BladeFormatter:()=>le,Formatter:()=>F});module.exports=qe(ht);var Xe=g(require("ignore"),1),b=g(require("chalk"),1),ae=g(require("find-config"),1),H=g(require("fs"),1),Je=g(require("glob"),1),v=g(require("lodash"),1),I=g(require("path"),1),f=g(require("process"),1),oe=g(require("util"),1);var W=class extends Error{};var Y=require("@shufo/tailwindcss-class-sorter"),ke=g(require("aigle"),1),w=g(require("detect-indent"),1),se=require("html-attribute-sorter"),E=g(require("js-beautify"),1),r=g(require("lodash"),1),lt=g(require("vscode-textmate"),1),Fe=g(require("xregexp"),1),S=g(require("string-replace-async"),1);function Ye(h){return h.split(`
...
`),(n=s.errors[0].params)!=null&&n.allowedValues&&console.log((i=s.errors[0].params)==null?void 0:i.allowedValues),f.default.exit(1)}}}async processPaths(){await Promise.all(v.default.map(this.paths,async e=>this.processPath(e)))}async processPath(e){await h.globFiles(e).then(t=>v.default.map(t,n=>I.default.relative(".",n))).then(t=>this.filterFiles(t)).then(this.fulFillFiles).then(t=>this.formatFiles(t))}static globFiles(e){return new Promise((t,n)=>{(0,Je.default)(e,(i,s)=>i?n(i):t(s))})}async filterFiles(e){if(this.ignoreFile==="")return e;let t=/^\.\.*/,n=v.default.filter(e,a=>t.test(I.default.relative(".",a))),i=v.default.xor(e,n),s=(0,Xe.default)().add(this.ignoreFile).filter(i);return v.default.concat(n,s)}static fulFillFiles(e){return this.targetFiles.push(e),Promise.resolve(e)}async formatFiles(e){await Promise.all(v.default.map(e,async t=>this.formatFile(t)))}async formatFile(e){await this.findTailwindConfig(e),await this.readRuntimeConfig(e),await G(e).then(t=>Promise.resolve(t.toString("utf-8"))).then(t=>new F(this.options).formatContent(t)).then(t=>this.checkFormatted(e,t)).then(t=>this.writeToFile(e,t)).catch(t=>{this.handleError(e,t)})}async checkFormatted(e,t){this.printFormattedOutput(e,t);let n=H.default.readFileSync(e,"utf-8"),i=X(n),s=X(t),a=xe(e,i,s);return this.diffs.push(a),this.outputs.push(t),a.length>0&&((this.options.progress||this.options.write)&&f.default.stdout.write(b.default.green("F")),this.options.checkFormatted&&(f.default.stdout.write(`${e}
...
`)}writeToFile(e,t){this.options.write&&(this.options.checkFormatted||t.length===0||v.default.isNull(t)||v.default.isEmpty(t)||H.default.writeFile(e,t,n=>{n&&(f.default.stdout.write(`${b.default.red(n.message)}
...
`));return}v.default.each(this.diffs,e=>be(e))}}printErrors(){v.default.isEmpty(this.errors)||(f.default.stdout.write(b.default.red.bold(`
Errors: 

`)),v.default.each(this.errors,e=>f.default.stdout.write(`${oe.default.format(e)}
